  ...
  return (
    <SidebarProvider defaultOpen>
      <div className="flex min-h-screen bg-transparent">
        <Sidebar collapsible="icon" variant="sidebar" side="left" className="border-r border-white/5 bg-background/40 backdrop-blur-xl">
        ...
        <SidebarInset className="flex-1 flex flex-col bg-transparent">
          <header className="sticky top-0 z-10 flex h-14 items-center gap-4 border-b border-white/5 bg-background/40 backdrop-blur-xl px-6 shadow-sm">
          ...
          <main className="flex-1 p-6 overflow-y-auto bg-transparent relative z-0">
            {children}
          </main>
        </SidebarInset>
      </div>
